                ...
                <div class="project-info">
                    <div class="project-header">
                        ...
                        <a class="github-link" href="https://github.com/nicole440/bird-observer" target="_blank"><img
                                class="logo" src="../assets/GitHub-PNG-Isolated-Photo.png" alt="GitHub logo"></a>
                    </div>
                ...
                <div class="project-info">
                    ...
                    <div class="project-description">
                        <p class="description">A Python program written in a Jupyter Notebook that extracts recent
                            ...
                            an email notification feature for updates on recent bird sightings based on specified
                            criteria.</p>
                    </div>
                </div>
                <div class="project-screenshot">
                ...
                <div class="project-info">
                    ...
                    <div class="project-description">
                        <p class="description">A full-stack application (in progress) that consumes the OpenBrewery
                            public
                            API to
                            allow users to search for Pennsylvania breweries by name, city, or zip code. Registered
                            users
